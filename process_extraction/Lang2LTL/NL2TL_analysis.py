...
TRAIN_DATA_PATH = os.path.join(
    "/home/ajshah",
    "Github/NL2TL-main/Data_total64220_03_26",
...
def check_test_leakage_v2(unique_train_formulas, test_formulas):
    ...
    with Pool(processes=16) as pool:
        common_flags = pool.imap(
            check_leakage_serial,
            zip([unique_formulas_str] * len(test_formulas), test_formulas_str),
        )
...
if __name__ == "__main__":
    ...
    n_common, common_formulas, novel_formulas = get_test_leakage(
        unique_train_formulas, test_formulas
    )
